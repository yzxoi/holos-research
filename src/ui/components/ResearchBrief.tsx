  ...
  return (
    <section class="holos-brief">
      ...
      <div class="holos-brief__head">
        <p class="holos-brief__summary">{brief.summary}</p>
      ...
      <div class="holos-brief__cols">
        <div class="holos-brief__col">
          <div class="holos-brief__label">
            ...
            DOING
            <span class="holos-meta">{brief.doing.length}</span>
          </div>
          <Show when={brief.doing.length > 0} fallback={<p class="holos-brief__empty">No active items</p>}>
            <For each={brief.doing}>
              {(item, i) => (
